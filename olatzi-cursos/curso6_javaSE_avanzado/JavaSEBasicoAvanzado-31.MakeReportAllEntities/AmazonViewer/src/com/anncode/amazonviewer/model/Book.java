...
public class Book extends Publication implements IVisualizable {
	...
	private ArrayList<Page> pages; //clase estática page
	...
	public void view(){
		...
		do {
			...
			if(response == 2) {
				...
				//salir del bucle if y del while
				break;
			}
	...
	public static ArrayList<Book> makeBookList() {
		...
		for(int i= 0; i<3; i++) {
			pagina = i+1;
			pages.add(new Book.Page(pagina, "El contenido de la página"));
			
			//Creación de un objeto de la clase estática 
			//ClaseOuter.ClaseNested nested = new ClaseOuter.ClaseNested();
